"""
ingestion/main.py — Phase 1 entry point

Runs scanner -> chunker over a repository and writes the result to
data/chunks.json. This is the file Phase 2 (embeddings) will read from.

We stop and write to disk here deliberately, rather than piping straight
into embeddings, so you can eyeball chunks.json and confirm ingestion is
sane before spending time/API calls on embeddings.
"""
